...
class Pathology(TemplateCopy):
    ...
    def set_and_get_differences(self, obj: Pathology):
        obj_update={
            "_id": self._id,
            "update": {}
        }
    ...
    def get_empty():
        ...
        return Pathology.from_json(obj=obj)

    @staticmethod
    def get_differences(old_obj: Pathology, new_obj: Pathology):
        obj_update={
            "_id": old_obj._id,
            "update": {}
        }
